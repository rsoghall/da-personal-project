...
handleAfternoonInHourSelect = e => {
  ...
  handleAfternoonOutHourSelect = e => {
    const { inValue } = this.state;
    const outValue = e.target.value;
    this.setState({
      outValue
    ...
    return (
      <div className="selectHours-selected">
        <div className="selectHours">
                <div>
                    <div className="selectTime"><span>Morning</span></div>
             IN:{" "}
            <select
              id="selectIN"
              name="inValue"
              onChange={this.handleMorningInHourSelect}
              value={inValue}
            >
          ...
          <div>
            ...
            <select
              disabled={inValue === ""}
              name="outValue"
              onChange={this.handleMorningOutHourSelect}
              value={outValue}
            >
              <option value="">Please Select</option>
              {formattedEndOptions}
                ...
                <div>
                    <div className="selectTime"><span>Afternoon</span></div>
             IN:{" "}
            <select
              id="selectIN"
              name="inValue"
              onChange={this.handleAfternoonInHourSelect}
              value={inValue}
            >
              <option value="">Please Select</option>
              {formattedStartOptions}
          ...
          <div>
            ...
            <select
              disabled={inValue === ""}
              name="outValue"
              onChange={this.handleAfternoonOutHourSelect}
              value={outValue}
            >
              <option value="">Please Select</option>
              {formattedEndOptions}
